...
void nrf52pwrClass::wakeUpByGPIO(uint8_t pinNo, uint8_t level){
...
void nrf52pwrClass::wakeUpByNFC(){
	NRF_NFCT->TASKS_SENSE=1;
}

void nrf52pwrClass::wakeUpByComp(uint8_t pin, nrf_lpcomp_ref_t reference, detect_mode mode){
...
resetReason nrf52pwrClass::whoIs(){
	uint32_t guilty;
...
void nrf52pwrClass::standbyMsec(uint32_t msec, void(*function)(void), standbyType mode){
...
void nrf52pwrClass::standbyMsec(uint32_t msec, void(*function)(void)){
	standbyMsec(msec, function, LOW_POWER);
}

void nrf52pwrClass::standby(uint32_t sec, void(*function)(void), standbyType mode){
	//register callback
	functionCallback=function;
...
void nrf52pwrClass::standby(uint32_t sec, void(*function)(void)){
	standby(sec, function, LOW_POWER);
}

void nrf52pwrClass::wakeUpNow(){
	event=true;
}

nrf52pwrClass nrf52pwr;
...
void TIMER2_IRQHandler(void){
	...
	event=true;
	if(nrf52pwr.functionCallback)
		nrf52pwr.functionCallback();
}
